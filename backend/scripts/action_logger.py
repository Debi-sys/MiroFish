"""
动作LogRecord器
用于RecordOASISSimulation中每个Agent的动作，供后端监控使用
...
class SimulationLogManager:
    ...
    def get_twitter_logger(self) -> PlatformActionLogger:
        """Get Twitter PlatformLogRecord器"""
