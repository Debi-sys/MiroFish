"""
测试ProfileFormatGenerateWhether符合OASIS要求
Validate：
1. Twitter ProfileGenerateCSVFormat
2. Reddit ProfileGenerateJSON详细Format
"""
...
def test_profile_formats():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print(f"   [Information] OptionalField: {present_optional}")
