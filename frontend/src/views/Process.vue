      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        <div class="panel-header">
          ...
          <div class="header-right">
            <template v-if="graphData">
              ...
              <span class="stat-item">{{ graphData.edge_count || graphData.edges?.length || 0 }} Relationship</span>
              <span class="stat-divider">|</span>
            </template>
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-hint">After generation completes, graph building will start automatically</p>
          </div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, LLM analyzes document content and automatically generates ontology structure suitable for opinion simulation (Entity Types + Relationship Types)
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Description</div>
                <div class="detail-content">
                  Based on the generated ontology, chunks documents and calls Zep API to build knowledge graph, extracting entities and relationships
                </div>
              </div>
              ...
              <div class="detail-section" v-if="graphData">
                ...
                <div class="build-result">
                  ...
                  <div class="result-item">
                    ...
                    <span class="result-label">RelationshipEdge</span>
                  </div>
                  <div class="result-item">
...
const currentPhase = ref(-1) // -1: Uploading, 0: Generating ontology, 1: Graph Building, 2: Complete
...
const handleNewProject = async () => {
  ...
  if (!pending.isPending || pending.files.length === 0) {
    error.value = 'No files pending upload, please return to home page and try again'
    loading.value = false
    return
  }
