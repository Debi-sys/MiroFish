    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a piece of text, <span class="highlight-bold">MiroFish</span> can automatically generate a parallel world composed of up to <span class="highlight-orange">millions of Agents</span> based on the reality seeds within it. Inject variables from a god's-eye view to find the <span class="highlight-code">"local optimal solution" in dynamic environments through complex group interactions.</span>
            </p>
            <p class="slogan-text">
              Let the future rehearse among Agents, let decisions prevail after countless battles<span class="blinking-cursor">_</span>
            </p>
          </div>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity relationship extraction & profile generation & environment configuration Agent injects simulation parameters</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual platform parallel simulation & auto-parse prediction requirements & dynamically update temporal memory</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Report Agent has a rich toolset for deep interaction with the post-simulation environment</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with any entity in the simulation world & chat with Report Agent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction requirements in natural language (e.g., What public opinion trends would occur if a university reverses a disciplinary action?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Redirect immediately to Process page (using special identifier for new project)
    router.push({
      name: 'Process',
...
:root {
  ...
  --border: #E5E5E5;
  /* 
    Use Space Grotesk as the main heading font, JetBrains Mono as the code/labels font
